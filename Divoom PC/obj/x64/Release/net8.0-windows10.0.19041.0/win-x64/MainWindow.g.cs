...
namespace DivoomPC
{
    partial class MainWindow : 
        global::DivoomPC.Controls.WindowEx, 
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
        ...
        {
            private global::DivoomPC.MainWindow dataRoot;
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = global::WinRT.CastExtensions.As<global::DivoomPC.MainWindow>(newDataRoot);
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::DivoomPC.MainWindow obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_RestoreCommand(obj.RestoreCommand, phase);
                        this.Update_ExitCommand(obj.ExitCommand, phase);
                    }
                }
            }
            private void Update_RestoreCommand(global::System.Windows.Input.ICommand obj, int phase)
            {
            ...
            private void Update_ExitCommand(global::System.Windows.Input.ICommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 3: // MainWindow.xaml line 40
                {
                    this.NotifyIcon = global::WinRT.CastExtensions.As<global::H.NotifyIcon.TaskbarIcon>(target);
                }
                break;
        ...
        public global::Microsoft.UI.Xaml.Markup.IComponentConnector GetBindingConnector(int connectionId, object target)
        {
            ...
            case 1: // MainWindow.xaml line 2
                {                    
                    global::DivoomPC.Controls.WindowEx element1 = (global::DivoomPC.Controls.WindowEx)target;
